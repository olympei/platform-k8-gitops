...
resource "aws_iam_policy" "aws_load_balancer_controller" {
  name        = "${local.unique_policies["EKS-AWSLoadBalancerController-Policy"].name}-${var.environment}"
  description = "${local.unique_policies["EKS-AWSLoadBalancerController-Policy"].description} for ${var.environment}"
